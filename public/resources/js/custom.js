$(document).ready(function () {
   ...
   $(".hotelDescriptions > .row").each(function(index){
       ...
       var address = $(this).find(".hotelAddress").text();
	...
	var minPriceFinal = minPrice[0].price;	
	...
	var maxPriceFinal = maxPrice[0].price;
	...
	$("#slider").slider({
        ...
        slide: function(event, ui) {			
            ...
            $(".rangeSlider .form-group").each(function(){
                var updtVal = $(this).find("input.sliderValue").val();
                $(this).find("span").text(updtVal);
            });		
...
//var itemsToBeSorted = $(".hotelDescriptions > .row");
    ...
    $(".searchHotelByName form").submit(function(e){
        ...
        var toShowAfterType = $(".hotelDescriptions").find('>.' + searched);
        ...
        $(this).click(function(){
           ...
           // console.log(alpha);
            ...
            $(".hotelDescriptions > .row").each(function(){                
                var searched = $(this).find(".hotelName").text().replace(/\s/g, "");
